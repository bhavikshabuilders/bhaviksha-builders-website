...
export default function Contact() {
  ...
  return (
    <section className=" overflow-hidden pt-[calc(var(--nav-height)+40px)] sm:pt-[calc(var(--nav-height)+45px)] bg-white text-[#111] ">
      {/*  HERO */}
      <div
        className="  max-w-6xl mx-auto px-6  pb-8 text-center"
        data-aos="fade-down"
      >
        ...
        <p
          className={`text-gray-600 max-w-2xl mx-auto ${
            i18n.language === "ta" ? "text-[16px] leading-[2]" : ""
          }`}
        >
          {t("contactTitle")}
        </p>
      ...
      {/* RESPONSE STRIP */}
      <div
        className="bg-[#0B1C2C] text-white py-3 text-center text-sm"
        data-aos="fade-up"
      >
        {t("responseStrip")}
      </div>
          ...
          {[
            ...
            >
              <div className="bg-white rounded-2xl p-7 h-full transition duration-300 group-hover:-translate-y-2 group-hover:shadow-2xl">
                ...
                {/* EXTRA */}
                <p className="text-xs text-gray-500 mb-6">{item.extra}</p>
  ...
  "
        ...
        ${i18n.language === "ta" ? "text-[13px] leading-[1.9]" : "text-sm"}
      `}
            data-aos="fade-up"
          >
            {t("serviceFoot")}
      ...
      <div className="bg-gray-50 py-8" data-aos="fade-up">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div data-aos="fade-right">
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">{t("whyDesc")}</p>
        ...
        "
          ...
          <div className="relative" data-aos="fade-left">
            ...
            >
              ...
              <p className="text-gray-600 text-sm mb-6">{t("successDesc")}</p>
            ...
            {/* FLOAT BADGE */}
            <div
              className="absolute -top-6 -right-2 bg-[oklch(0.47_0.17_28.33)] text-white text-xs px-5 py-2 rounded-full shadow-lg"
              data-aos="zoom-in"
              data-aos-delay="200"
            >
              {t("trustedBadge")}
