...
export default function Projects() {
  ...
  return (
    <section className="pt-[calc(var(--nav-height)+40px)] sm:pt-[calc(var(--nav-height)+45px)] pb-15 overflow-hidden bg-white">
      ...
      "
        ...
        <div className="mt-18 text-center px-4 sm:px-6" data-aos="fade-up">
          <h3 className="text-3xl font-bold mb-4">{t("blueprintPoint1")}</h3>

          <p className="text-gray-600 mb-12">{t("youtubeDesc")}</p>
...
function Info({ icon, label, value }) {
  return (
    <div className="flex items-center gap-3 bg-white/70 backdrop-blur-md p-4 rounded-xl shadow-sm">
      <div className="text-[oklch(0.47_0.17_28.33)] text-lg">{icon}</div>
      <div>
