  ...
  return (
    <section className=" bg-white pt-[calc(var(--nav-height)+40px)] sm:pt-[calc(var(--nav-height)+10px)] bg-white text-[#0B1C2C] overflow-hidden">
      <div className="max-w-7xl mx-auto px-3 sm:px-6">
        ...
        tracking-[4px]
        mb-4
        ${i18n.language === "ta" ? "text-[11px]" : "text-[10px]"}
      `}
            >
              {t("leaderBadge")}
            </p>
    ...
    "
        ...
        "
          ...
          mb-3
          ${i18n.language === "ta" ? "text-[14px]" : "text-sm"}
        `}
              >
                {t("founderRole")}
              </p>
          ...
          ${i18n.language === "ta" ? "text-[34px] leading-[1.3]" : "text-5xl"}
        `}
              >
                S Chinraj
              </h3>
    ...
    "
        ...
        `}
              ...
              <h3
                className={`
          font-bold text-[#0B1C2C] mb-6
          ${i18n.language === "ta" ? "text-[30px] leading-[1.35]" : "text-5xl"}
        `}
              >
      ...
      "
          ...
          "
            ...
            ${i18n.language === "ta" ? "text-[28px] leading-[1.3]" : "text-3xl"}
          `}
                >
                  {t("visionHeading")}
                </h3>
