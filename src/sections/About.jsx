    ...
    <section className="py-10 sm:py-10 bg-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="w-full overflow-hidden">
          <p
            className="inline-block text-[oklch(0.47_0.17_28.33)] text-[13px] tracking-[3px] px-3 py-1 rounded backdrop-blur-sm bg-white/[0.04]"
            data-aos="fade-left"
          >
            {t("aboutBadge")}
          </p>
    ...
    <div className="flex items-center gap-3" data-aos="fade-up">
      ...
      <p
        className={`text-gray-700 font-medium ${
          text?.length > 18 ? "text-[15px] leading-[1.9]" : "text-sm"
        }`}
      >
        {text}
      </p>
...
function Stat({ number, label, delay }) {
  ...
  return (
    <div id={`stat-${number}`} data-aos="fade-up" data-aos-delay={delay}>
      <h3 className="text-2xl font-bold text-[#0B1C2C]">{count}+</h3>
