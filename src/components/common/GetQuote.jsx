...
export default function GetQuote() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.plotSize.trim()) {
      newErrors.plotSize = "Please enter plot size";
    }

    if (!form.requirements.trim()) {
      newErrors.requirements = "Please enter project requirements";
    }
  ...
  return (
    <section className="bg-white text-[#111] overflow-hidden">
      {/* HERO */}
      <div
        className="max-w-6xl mx-auto px-6 pt-[calc(var(--nav-height)+60px)] pb-12 text-center"
        data-aos="fade-down"
      >
        <p
                ...
                <div className="bg-[#0f2a40] rounded-2xl p-6 h-full transition duration-300 group-hover:-translate-y-2 group-hover:shadow-2xl">
                  ...
                  <p
                    className={`text-gray-500 mt-3 ${
                      i18n.language === "ta" ? "text-[12px]" : "text-xs"
                    }`}
                  >
                    {t("includedProjects")}
                  </p>
      ...
      <div className="bg-gray-50 py-12" data-aos="fade-up">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <div className="relative" data-aos="fade-right">
            ...
            <div
              className="absolute -bottom-8 -left-0 bg-white shadow-2xl rounded-2xl px-6 py-5 w-[220px]"
              data-aos="fade-up"
              data-aos-delay="150"
            >
            ...
            {/* TOP BADGE */}
            <div
              className="absolute top-4 right-4 bg-black/70 text-white text-xs px-4 py-2 rounded-full backdrop-blur"
              data-aos="zoom-in"
              data-aos-delay="250"
            >
              {t("experience")}
      ...
      {/* FORM */}
      <div className="py-8 bg-white" data-aos="fade-up">
        <div className="max-w-7xl mx-auto px-6">
          {/* HEADER */}
          <div className="text-center mb-16" data-aos="fade-down">
            <p className="text-[oklch(0.47_0.17_28.33)] tracking-[5px] text-xs mb-3">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-8" data-aos="fade-right">
              ...
              <div
                className="bg-[#0B1C2C] text-white rounded-2xl p-6 shadow-lg"
                data-aos="fade-up"
                data-aos-delay="100"
              >
                ...
                <div
                  className="flex gap-6 text-xs text-gray-300"
                  data-aos="fade-up"
                  data-aos-delay="200"
                >
                  <span>✔ {t("exp10")}</span>
            ...
            {/* FORM PANEL */}
            <div
              className="bg-white border border-gray-300 rounded-3xl p-8 shadow-[0_10px_40px_rgba(0,0,0,0.08)]"
              data-aos="fade-left"
            >
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      placeholder={t("boqFullNamePlaceholder")}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="premiumInput"
                      placeholder={t("boqPhonePlaceholder")}
                    />
                ...
                <div>
                  ...
                  <input
                    ...
                    className="premiumInput"
                    placeholder={t("boqLocationPlaceholder")}
                  />
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <select
                      ...
                      className="premiumInput"
                    >
                      <option value="">{t("boqProjectTypePlaceholder")}</option>
                      <option>2BHK</option>
                      <option>3BHK</option>
                      <option>Villa</option>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="premiumInput"
                    >
                      <option value="">{t("boqBudgetPlaceholder")}</option>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="premiumInput"
                    placeholder={t("boqPlotSizePlaceholder")}
                  />
                ...
                <button
                  type="submit"
                  className=" cursor-pointer w-full bg-[oklch(0.47_0.17_28.33)] text-white py-3 rounded-xl font-medium hover:brightness-110 transition"
                >
                  {t("getEstimate")}
                </button>
      ...
      {success && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          {/* MODAL */}
          <div
            className="relative bg-white rounded-3xl px-10 py-10 text-center shadow-[0_20px_80px_rgba(0,0,0,0.3)] max-w-md w-full animate-[fadeIn_0.4s_ease]"
            data-aos="zoom-in"
          >
            {/* SUCCESS ICON */}
            <div
