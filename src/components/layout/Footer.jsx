        ...
        <div>
          ...
          <ul className="space-y-3 text-gray-400 text-sm">
            {[
              ...
              { name: t("workforceMenu"), path: "/worker-request" },
        ...
        <div>
          ...
          <div className="space-y-4 text-gray-400 text-sm mb-6">
            <p className="flex items-center gap-3">
              <FaPhoneAlt className="text-[oklch(0.47_0.17_28.33)]" /> +91 95852
              75171
            </p>
            <p className="flex items-center gap-3">
              <FaPhoneAlt className="text-[oklch(0.47_0.17_28.33)]" /> +91 86757
              83639
            </p>
            <p className="flex items-center gap-3">
            ...
            <p
              className={`mb-2 ${
                i18n.language === "ta" ? "text-[15px] leading-[1.8]" : "text-sm"
              }`}
            >
              📍 {t("contactAddress")}
            </p>
          ...
          <div className="flex gap-3">
            {[
              {
                icon: <FaWhatsapp />,
                link: "https://wa.me/919585275171",
                color: "hover:bg-[oklch(0.47_0.17_28.33)]",
              },
              {
                icon: <FaInstagram />,
                link: "https://www.instagram.com/bhavikshabuilders?igsh=ZWowd3JtbnR1bHli",
                color: "hover:bg-[oklch(0.47_0.17_28.33)]",
              },
              {
                icon: <FaYoutube />,
                link: "https://youtube.com/@bhavikshabuilders3620?si=-fE1v-27M3hj3veZ",
                color: "hover:bg-[oklch(0.47_0.17_28.33)]",
              },
              {
                icon: <FaGoogle />,
